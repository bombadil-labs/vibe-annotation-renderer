...
# Vibe Banner — Noto animated variant

This is the vibe-banner skill with one difference: **your face comes from the Noto animated
...
<script>(function(){
  ...
  s.src = 'https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-banner@53e377a716b1c53b59b6fd7d9e5c32a2348d8d14/dist/vibe.min.js';
  s.onload = function(){
    vibe(document.getElementById('v'), {
      face: { set: "noto-animated", item: "content" },
      kaomoji: "( ˘ ᵕ ˘ )",
      readout: [
        { label: "user", value: "…" },
        { label: "mood", value: "…" },
...
This file was generated by the vibe-banner builder at version **0.41.3**.
