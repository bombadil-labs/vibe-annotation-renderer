...
<script>(function(){
  ...
  s.src = 'https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-banner@c4b06ee5479a45217301160e9d3abd25571cfe8c/dist/vibe.min.js';
  s.onload = function(){
    vibe(document.getElementById('v'), {
      avatar: {
        set: "noto-animated", item: "content",
      },
      details: {
        readout: [
          { label: "user", value: "…" },
...
This file was generated by the vibe-banner builder at version **0.42.2**.
