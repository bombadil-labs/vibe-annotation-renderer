...
# Vibe Banner — Sepia variant

This is the vibe-banner skill with one difference: **your face is Sepia**, a small
...
<script>(function(){
  ...
  s.src = 'https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-banner@111f63369d0cd70eeef4e39d91e4d0c644ff75ba/dist/vibe.min.js';
  s.onload = function(){
    vibe(document.getElementById('v'), {
      avatar: {
        set: "sepia", item: "content",
      },
      details: {
        readout: [
          { label: "user", value: "…" },
...
This file was generated by the vibe-banner builder at version **0.45.0**.
