...
```html
<div id="v"></div>
<script src="https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-annotation-renderer@v0.1.6/dist/vibe.min.js"></script>
...
(`@v0.1.6`) and bump it when the renderer updates. The renderer, a live gallery of every state, and its 
