...
```html
<div id="v"></div>
<script src="https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-annotation-renderer@f21a1f66d712da651bb9391fbc6bd491cace06d2/dist/vibe.min.js"></script>
<script>
...
```js
face: {
  url: "https://cdn.jsdelivr.net/gh/bombadil-labs/vibe-annotation-renderer@f21a1f66d712da651bb9391fbc6bd491cace06d2/assets/kip-sheet.png",
